...
console.log('Equality test with number:', 26 == 20);
//Numerical Test with Inequality
console.log('Inequality test with number: ', 20 == 20);
console.log('Inequality test with number: ', 20 == 23);
...
console.log('Or operators test: ', 5 === 10 || false);
...
console.log("Test Bnanana is not in Array: ", !fruits.includes("Orange"));
